...
INFO = [
    ("__header__", "fowzi ali", ""),
    ("__rule__",   "", ""),
    ("Role",       "MERN Intern @ 10Pearls  ·  Data Science Intern @ AKU IGHD", "val"),
    ("Edu",        "BS Computer Science, Habib University  ·  Class of 2027", "val"),
    ("Focus",      "Full-Stack  ·  ML / Data Science  ·  Distributed Systems", "accent"),
    ("GPA",        "3.87 / 4.0  ·  Dean's List — Spring 2026", "val"),
    ("__blank__",  "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",       "Python · C++ · JavaScript · TypeScript · SQL", "val"),
    ("ML / Data",  "TensorFlow · PyTorch · XGBoost · Scikit-learn · Pandas", "val"),
    ("Web",        "Node.js · Express · React · FastAPI · WebSockets", "val"),
    ("Infra",      "Docker · PostgreSQL · MongoDB · MySQL · Git · Linux", "val"),
    ("__blank__",  "", ""),
    ("__section__", "~/projects", ""),
    ("Archiv",     "RAG document intelligence — local-first semantic search", "warn"),
    ("",           "Python · LangChain · FastAPI · Vector DB", "muted"),
    ("Bridge",     "Multi-role school management platform — RBAC, 4 roles", "warn"),
    ("",           "FastAPI · React · MySQL · Tailwind CSS", "muted"),
    ("Milap",      "B2B event vendor platform — WebSockets, Docker, JIRA", "warn"),
    ("",           "Python · PostgreSQL · WebSockets · Docker", "muted"),
    ("CRDT Editor","Real-time collaborative editor — delta-state sync", "warn"),
    ("",           "JavaScript · WebSockets · CRDTs", "muted"),
    ("__blank__",  "", ""),
    ("__section__", "~/highlights", ""),
    ("Honor",      "Berkeley Global Summer School — competitive intl. program", "val"),
    ("Honor",      "Dean's List · 2nd in Karachi — Intermediate CS", "val"),
    ("__stats__",  "", ""),
    ("__blank__",  "", ""),
    ("__section__", "~/reach", ""),
    ("In",         "linkedin.com/in/fowzii", "accent"),
    ("Mail",       "fowzialiwork@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to SWE / AI / ML roles </tspan>'
